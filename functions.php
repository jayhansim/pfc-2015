...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('square', 500, 500, true); // Custom Thumbnail Size call using the_post_thumbnail('square');
...
function html5blank_conditional_scripts()
{
    ...
    //     wp_register_script('google-map', '//maps.googleapis.com/maps/api/js?sensor=false'); // Custom scripts
    //     wp_enqueue_script('google-map'); // Enqueue it!
    // }
}
...
// add_shortcodeode('html5_shortcode_demo_2', 'html5_shortcode_demo_2'); // Place [html5_shortcode_demo_2] in Pages, Posts now.
